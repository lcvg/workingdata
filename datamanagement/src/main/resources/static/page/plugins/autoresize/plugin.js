...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_1y3wse8ejfeu9hqr.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_1y3wse8ejfeu9hqr.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_1y3wse8ejfeu9hqr.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_1y3wse8ejfeu9hqr.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_1y3wse8ejfeu9hqr.getAutoResizeBottomMargin(editor);
    ...
    if ($_1y3wse8ejfeu9hqr.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_f9pkf98bjfeu9hql.resize(editor, oldSize);
    });
  };
  var $_2ztrg38ajfeu9hqi = { register: register };

  global.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_2ztrg38ajfeu9hqi.register(editor, oldSize);
      $_f9pkf98bjfeu9hql.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
