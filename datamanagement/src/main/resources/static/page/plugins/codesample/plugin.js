...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_3qi7pp9pjfeu9hyw.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_1tji0s9ljfeu9hxy.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_7d4oun9njfeu9hy1.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_epv9699qjfeu9hyy = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_e80kir9kjfeu9hxw = {
    open: function (editor) {
      var minWidth = $_1tji0s9ljfeu9hxy.getDialogMinWidth(editor);
      var minHeight = $_1tji0s9ljfeu9hxy.getDialogMinHeight(editor);
      var currentLanguage = $_epv9699qjfeu9hyy.getCurrentLanguage(editor);
      var currentLanguages = $_epv9699qjfeu9hyy.getLanguages(editor);
      var currentCode = $_7d4oun9njfeu9hy1.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_7d4oun9njfeu9hy1.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_3qi7pp9pjfeu9hyw.isCodeSample(node)) {
        $_e80kir9kjfeu9hxw.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_8mbgdv9jjfeu9hxv = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_3qi7pp9pjfeu9hyw.trimArg($_3qi7pp9pjfeu9hyw.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_3qi7pp9pjfeu9hyw.trimArg($_3qi7pp9pjfeu9hyw.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_d8zk6m9rjfeu9hz0 = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_1tji0s9ljfeu9hxy.getContentCss(editor);
  ...
  var $_qpveo9sjfeu9hz3 = { loadCss: loadCss };
  ...
  var $_3zjmc59tjfeu9hz4 = { register: register$1 };

  var addedInlineCss = Cell(false);
  global$1.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_d8zk6m9rjfeu9hz0.setup(editor);
    $_3zjmc59tjfeu9hz4.register(editor);
    $_8mbgdv9jjfeu9hxv.register(editor);
    editor.on('init', function () {
      $_qpveo9sjfeu9hz3.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_3qi7pp9pjfeu9hyw.isCodeSample(ev.target)) {
        $_e80kir9kjfeu9hxw.open(editor);
      }
    });
  });
