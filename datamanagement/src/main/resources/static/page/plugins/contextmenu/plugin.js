...
var contextmenu = (function () {
  ...
  var $_88otwra4jfeu9i1v = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_8icm7oa3jfeu9i1t.getContextMenu(editor);
  ...
  var $_4fuw1a7jfeu9i1z = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_8icm7oa3jfeu9i1t.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_4fuw1a7jfeu9i1z.show(editor, $_88otwra4jfeu9i1v.getPos(editor, e), visibleState, menu);
    });
  };
  var $_8hyga5a2jfeu9i1r = { setup: setup };

  global.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_8hyga5a2jfeu9i1r.setup(editor, visibleState, menu);
    return $_bzf5owa1jfeu9i1o.get(visibleState);
  });
  function Plugin () {
  }
