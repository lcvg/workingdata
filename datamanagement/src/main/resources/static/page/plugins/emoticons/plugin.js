...
var emoticons = (function () {
  ...
  var $_6f57stajjfeu9i3g = { getHtml: getHtml };
  ...
  var register = function (editor, pluginUrl) {
    var panelHtml = $_6f57stajjfeu9i3g.getHtml(pluginUrl);
  ...
  var $_ah5zeiaijfeu9i3d = { register: register };

  global.add('emoticons', function (editor, pluginUrl) {
    $_ah5zeiaijfeu9i3d.register(editor, pluginUrl);
  });
  function Plugin () {
  }
