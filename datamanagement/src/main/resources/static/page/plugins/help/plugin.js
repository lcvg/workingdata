...
var help = (function () {
  ...
  var never$1 = $_epm6wzasjfeu9i4s.never;
  var always$1 = $_epm6wzasjfeu9i4s.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_epm6wzasjfeu9i4s.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var $_chy8nsaujfeu9i4w = { shortcuts: shortcuts };
  ...
  var makeTab = function () {
    ...
    var shortcutLisString = $_8g37loaqjfeu9i4h.map($_chy8nsaujfeu9i4w.shortcuts, function (shortcut) {
  ...
  var $_2pubvaapjfeu9i49 = { makeTab: makeTab };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_27r5vazjfeu9i5k.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_27r5vazjfeu9i5k.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_27r5vazjfeu9i5k.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_27r5vazjfeu9i5k.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_fllaf4b0jfeu9i5n.head(str).bind(function (head) {
      return $_fllaf4b0jfeu9i5n.tail(str).map(function (tail) {
  ...
  var $_1xsvbdb1jfeu9i5p = { urls: urls };

  var makeLink = $_epm6wzasjfeu9i4s.curry($_aajs38ayjfeu9i5g.supplant, '<a href="${url}" target="_blank" rel="noopener">${name}</a>');
  var maybeUrlize = function (editor, key) {
    return $_8g37loaqjfeu9i4h.find($_1xsvbdb1jfeu9i5p.urls, function (x) {
      return x.key === key;
    }).fold(function () {
  ...
  var getPluginKeys = function (editor) {
    var keys = $_c2ik3qaxjfeu9i5c.keys(editor.plugins);
    return editor.settings.forced_plugins === undefined ? keys : $_8g37loaqjfeu9i4h.filter(keys, $_epm6wzasjfeu9i4s.not($_epm6wzasjfeu9i4s.curry($_8g37loaqjfeu9i4h.contains, editor.settings.forced_plugins)));
  };
  var pluginLister = function (editor) {
    var pluginKeys = getPluginKeys(editor);
    var pluginLis = $_8g37loaqjfeu9i4h.map(pluginKeys, function (key) {
  ...
  var $_2xsl3uawjfeu9i52 = { makeTab: makeTab$1 };
  ...
  var $_6udye0b2jfeu9i5s = { makeRow: makeRow };
  ...
  var open = function (editor, pluginUrl) {
    return function () {
      editor.windowManager.open({
        ...
        layout: 'flex',
        body: [
          $_2pubvaapjfeu9i49.makeTab(),
          $_2xsl3uawjfeu9i52.makeTab(editor)
        ],
        buttons: $_6udye0b2jfeu9i5s.makeRow(),
  ...
  var $_7spwnyaojfeu9i47 = { open: open };

  var register = function (editor, pluginUrl) {
    editor.addCommand('mceHelp', $_7spwnyaojfeu9i47.open(editor, pluginUrl));
  };
  var $_221d0aanjfeu9i45 = { register: register };

  var register$1 = function (editor, pluginUrl) {
    editor.addButton('help', {
      icon: 'help',
      onclick: $_7spwnyaojfeu9i47.open(editor, pluginUrl)
    });
  ...
  var $_abayyob4jfeu9i5v = { register: register$1 };

  global.add('help', function (editor, pluginUrl) {
    $_abayyob4jfeu9i5v.register(editor, pluginUrl);
    $_221d0aanjfeu9i45.register(editor, pluginUrl);
