...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_3lwfuie7jfeu9is5.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_3lwfuie7jfeu9is5.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_3lwfuie7jfeu9is5.getSelectorConverter(editor)) {
      selectorConverter = $_3lwfuie7jfeu9is5.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_3lwfuie7jfeu9is5.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_3lwfuie7jfeu9is5.getCssGroups(editor));
      ...
      if (!$_3lwfuie7jfeu9is5.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      global$4.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_3lwfuie7jfeu9is5.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_5gmwkje2jfeu9iry.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_32ie3re1jfeu9iru = { get: get };

  global.add('importcss', function (editor) {
    $_5gmwkje2jfeu9iry.setup(editor);
    return $_32ie3re1jfeu9iru.get(editor);
  });
  function Plugin () {
  }
