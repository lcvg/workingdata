...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_7dkxx3i8jfeu9jd9.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_7dkxx3i8jfeu9jd9.getPreviewDialogWidth(editor);
    var dialogHeight = $_7dkxx3i8jfeu9jd9.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_3jn8r7i9jfeu9jdd.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_cpcgs0i6jfeu9jd7 = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_cpcgs0i6jfeu9jd7.open(editor);
    });
  };
  var $_5wuwzi5jfeu9jd5 = { register: register };
  ...
  var $_esoeweibjfeu9jdh = { register: register$1 };

  global.add('preview', function (editor) {
    $_5wuwzi5jfeu9jd5.register(editor);
    $_esoeweibjfeu9jdh.register(editor);
  });
  function Plugin () {
  }
