...
var toc = (function () {
  ...
  var $_dw2vnxr0jfeu9lsl = { create: create };

  var tocId = $_dw2vnxr0jfeu9lsl.create('mcetoc_');
  ...
  var readHeaders = function (editor) {
    var tocClass = $_5u4u57qzjfeu9lsj.getTocClass(editor);
    var headerTag = $_5u4u57qzjfeu9lsj.getTocHeader(editor);
    var selector = generateSelector($_5u4u57qzjfeu9lsj.getTocDepth(editor));
  ...
  var generateTocHtml = function (editor) {
    ...
    return '<div class="' + editor.dom.encode($_5u4u57qzjfeu9lsj.getTocClass(editor)) + '" contenteditable="false">' + html + '</div>';
  };
  var generateTocContentHtml = function (editor) {
    ...
    html += generateTitle($_5u4u57qzjfeu9lsj.getTocHeader(editor), global$2.translate('Table of Contents'));
    for (i = 0; i < headers.length; i++) {
      h = headers[i];
      h.element.id = h.id;
  ...
  var register = function (editor) {
    editor.addCommand('mceInsertToc', function () {
      $_b1zj0jqvjfeu9lsc.insertToc(editor);
    });
    editor.addCommand('mceUpdateToc', function () {
      $_b1zj0jqvjfeu9lsc.updateToc(editor);
    });
  };
  var $_4h7dozqujfeu9ls8 = { register: register };

  var setup = function (editor) {
    var $ = editor.$, tocClass = $_5u4u57qzjfeu9lsj.getTocClass(editor);
  ...
  var $_4hiqv5r1jfeu9lsm = { setup: setup };

  var toggleState = function (editor) {
    return function (e) {
      var ctrl = e.control;
      editor.on('LoadContent SetContent change', function () {
        ctrl.disabled(editor.readonly || !$_b1zj0jqvjfeu9lsc.hasHeaders(editor));
      });
    };
  };
  var isToc = function (editor) {
    return function (elm) {
      return elm && editor.dom.is(elm, '.' + $_5u4u57qzjfeu9lsj.getTocClass(editor)) && editor.getBody().contains(elm);
    };
  };
  ...
  var $_a3699yr2jfeu9lsp = { register: register$1 };

  global.add('toc', function (editor) {
    $_4h7dozqujfeu9ls8.register(editor);
    $_a3699yr2jfeu9lsp.register(editor);
    $_4hiqv5r1jfeu9lsm.setup(editor);
  });
  function Plugin () {
  }
