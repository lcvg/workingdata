...
var wordcount = (function () {
  ...
  var $_1mmmams6jfeu9ly0 = {
    each: each,
    map: map
  };

  var SETS$1 = $_45jsess4jfeu9lxu.SETS;
  var OTHER = $_45jsess4jfeu9lxu.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_1mmmams6jfeu9ly0.map(string.split(''), memoized);
  };
  var $_55e321s5jfeu9lxy = { classify: classify };

  var ci = $_45jsess4jfeu9lxu.characterIndices;
  ...
  var $_84ax8cs7jfeu9ly3 = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_45jsess4jfeu9lxu.EMPTY_STRING;
  var WHITESPACE$1 = $_45jsess4jfeu9lxu.WHITESPACE;
  var PUNCTUATION$1 = $_45jsess4jfeu9lxu.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_55e321s5jfeu9lxy.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_84ax8cs7jfeu9ly3.isWordBoundary(map, i)) {
  ...
  var $_3pz2its3jfeu9lxr = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_3pz2its3jfeu9lxr.getWords(getTextContent(editor)).length;
  };
  var $_kfdfus2jfeu9lxp = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_kfdfus2jfeu9lxp.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_aomb50s1jfeu9lxn = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return global$2.translate([
        '{0} words',
        $_kfdfus2jfeu9lxp.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_f4icrhs8jfeu9ly6 = { setup: setup };

  global.add('wordcount', function (editor) {
    $_f4icrhs8jfeu9ly6.setup(editor);
    return $_aomb50s1jfeu9lxn.get(editor);
  });
  function Plugin () {
  }
