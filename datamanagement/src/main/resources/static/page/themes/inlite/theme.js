...
var inlite = (function () {
  ...
  var $_eojjia16jjfeu9q69 = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_bvgpe216njfeu9q6g.fromClientRect(clientRect)) : null;
  };
  var $_44xu4g16mjfeu9q6e = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          var result = $_dqjyd416ljfeu9q6c.result(predicateIds[i].id, $_44xu4g16mjfeu9q6e.getElementRect(editor, element));
          return result;
        }
      }
      return null;
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_dqjyd416ljfeu9q6c.result(predicateIds[x].id, $_44xu4g16mjfeu9q6e.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        var result = $_dqjyd416ljfeu9q6c.result(id, $_44xu4g16mjfeu9q6e.getSelectionRect(editor));
        return result;
      }
      return null;
    };
      ...
      for (i = 0; i < elements.length; i++) {
        if (elements[i].nodeName in textBlockElementsMap) {
          if (editor.dom.isEmpty(elements[i])) {
            return $_dqjyd416ljfeu9q6c.result(id, $_44xu4g16mjfeu9q6e.getSelectionRect(editor));
          }
          return null;
        }
      }
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_f93l816wjfeu9q6v.isArray(value)) {
      return value;
    } else if ($_f93l816wjfeu9q6v.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_f93l816wjfeu9q6v.isBoolean(value)) {
  ...
  var $_e9kwgt16vjfeu9q6t = {
    getStringOr: getByTypeOr($_f93l816wjfeu9q6v.isString),
    getBoolOr: getByTypeOr($_f93l816wjfeu9q6v.isBoolean),
    getNumberOr: getByTypeOr($_f93l816wjfeu9q6v.isNumber),
    getHandlerOr: getByTypeOr($_f93l816wjfeu9q6v.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_f93l816wjfeu9q6v.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_bvgpe216njfeu9q6g.toClientRect(targetRect),
        contentAreaRect: $_bvgpe216njfeu9q6g.toClientRect(contentAreaRect),
        panelRect: $_bvgpe216njfeu9q6g.toClientRect(panelRect)
      });
      return $_bvgpe216njfeu9q6g.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_e9kwgt16vjfeu9q6t.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_e9kwgt16vjfeu9q6t.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_e9kwgt16vjfeu9q6t.getHandlerOr(editor, 'inline_toolbar_position_handler', $_esnzuy16xjfeu9q6x.defaultHandler);
  };
  ...
  var fireSkinLoaded$1 = function (editor, callback) {
    var done = function () {
      ...
      $_53lsv416sjfeu9q6p.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_11mw2u16tjfeu9q6r.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded$1(editor, callback);
    };
    if ($_11mw2u16tjfeu9q6r.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_e4nej916rjfeu9q6n = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_eojjia16jjfeu9q69.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_ehib7i16ojfeu9q6h.fromContextToolbars(toolbars);
    result = $_dqjyd416ljfeu9q6c.match(editor, [
      $_c3m47216kjfeu9q6a.element(elements[0], contextToolbarsPredicateIds),
      $_74pfy916qjfeu9q6k.textSelection('text'),
      $_74pfy916qjfeu9q6k.emptyTextBlock(elements, 'insert'),
      $_c3m47216kjfeu9q6a.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_dqjyd416ljfeu9q6c.match(editor, [$_74pfy916qjfeu9q6k.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_e4nej916rjfeu9q6n.load(editor, function () {
  ...
  var $_7f9kw416fjfeu9q5s = { renderUI: renderUI };
  ...
  var never$1 = $_c7eek2172jfeu9q7g.never;
  var always$1 = $_c7eek2172jfeu9q7g.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_c7eek2172jfeu9q7g.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self.borderBox = $_el2os1179jfeu9q8h.parseBox(settings.border);
      self.paddingBox = $_el2os1179jfeu9q8h.parseBox(settings.padding);
      self.marginBox = $_el2os1179jfeu9q8h.parseBox(settings.margin);
      if (settings.hidden) {
        self.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_a5l5zl17hjfeu9q91.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self.borderBox = self.borderBox || $_el2os1179jfeu9q8h.measureBox(elm, 'border');
      self.paddingBox = self.paddingBox || $_el2os1179jfeu9q8h.measureBox(elm, 'padding');
      self.marginBox = self.marginBox || $_el2os1179jfeu9q8h.measureBox(elm, 'margin');
    ...
    reflow: function () {
      $_17wfps17gjfeu9q8z.remove(this);
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_a5l5zl17hjfeu9q91.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_a5l5zl17hjfeu9q91.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_gaufhv17ijfeu9q96 = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_a5l5zl17hjfeu9q91.getUiContainer(self);
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_a5l5zl17hjfeu9q91.inheritUiContainer(this, this._tooltip);
  ...
  function NotificationManagerImpl (editor) {
    ...
    var prePositionNotifications = function (notifications) {
      $_49sleu170jfeu9q78.each(notifications, function (notification) {
    ...
    var positionNotifications = function (notifications) {
      if (notifications.length > 0) {
        ...
        $_49sleu170jfeu9q78.each(notifications, function (notification, index) {
          if (index > 0) {
  ...
  var Window = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self._fullscreen) {
        ...
        if (!state) {
          self.borderBox = $_el2os1179jfeu9q8h.parseBox(self.settings.border);
          ...
          self.borderBox = $_el2os1179jfeu9q8h.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_7f9kw416fjfeu9q5s.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var unsafe = function (name, scope) {
    return $_drfdd0181jfeu9qbd.resolve(name, scope);
  };
  ...
  var $_d8ys3r180jfeu9qb7 = { getOrDie: getOrDie };

  function FileReader () {
    var f = $_d8ys3r180jfeu9qb7.getOrDie('FileReader');
    return new f();
  }
  ...
  var $_dg9tn117yjfeu9qaz = { blobToBase64: blobToBase64 };
  ...
  var $_amu1ap184jfeu9qbh = { pickFile: pickFile };
  ...
  var $_6xfjqe186jfeu9qbn = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_19oxsm188jfeu9qbr.create(dom, selection.getRng());
    global$4.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_19oxsm188jfeu9qbr.resolve(dom, bookmark));
  };
  ...
  var $_963jeg187jfeu9qbo = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_6xfjqe186jfeu9qbn.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_963jeg187jfeu9qbo.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_e3b8nd185jfeu9qbj.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name_1 = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_amu1ap184jfeu9qbh.pickFile().then(function (files) {
          var blob = files[0];
          $_dg9tn117yjfeu9qaz.blobToBase64(blob).then(function (base64) {
            $_e3b8nd185jfeu9qbj.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_e3b8nd185jfeu9qbj.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_fll43817xjfeu9qax = { addToEditor: addToEditor };
  ...
  var $_4sbwxz18cjfeu9qca = { getUiContainerDelta: getUiContainerDelta$1 };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_6sysro18ejfeu9qch.isAbsolute(href) && $_6sysro18ejfeu9qch.isDomainLike(href) ? askAboutPrefix(editor, href) : global$13.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_e3b8nd185jfeu9qbj.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_e3b8nd185jfeu9qbj.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_c73tpz18djfeu9qce = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_f93l816wjfeu9q6v.isArray(items)) {
      return items;
    } else if ($_f93l816wjfeu9q6v.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
    ...
    global$4.each(itemsToArray$1(items), function (item) {
      if (item === '|') {
        ...
        if (editor.buttons[item]) {
          ...
          if ($_f93l816wjfeu9q6v.isFunction(button)) {
            button = button();
          }
  ...
  var $_2kriof18fjfeu9qcj = { create: create$2 };

  var create$3 = function () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return global$4.map(toolbars, function (toolbar) {
        return $_2kriof18fjfeu9qcj.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_2kriof18fjfeu9qcj.create(editor, 'text', $_11mw2u16tjfeu9q6r.getTextSelectionToolbarItems(editor)),
        $_2kriof18fjfeu9qcj.create(editor, 'insert', $_11mw2u16tjfeu9q6r.getInsertToolbarItems(editor)),
        $_c73tpz18djfeu9qce.createQuickLinkForm(editor, hide)
      ]);
      return global$11.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_11mw2u16tjfeu9q6r.getPositionHandler(editor);
      contentAreaRect = $_44xu4g16mjfeu9q6e.getContentAreaRect(editor);
      panelRect = global$2.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_esnzuy16xjfeu9q6x.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_esnzuy16xjfeu9q6x.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_4sbwxz18cjfeu9qca.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_esnzuy16xjfeu9q6x.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_44xu4g16mjfeu9q6e.getContentAreaRect(editor);
        panelRect = global$2.DOM.getRect(panel.getEl());
        result = $_esnzuy16xjfeu9q6x.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_esnzuy16xjfeu9q6x.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_53lsv416sjfeu9q6p.fireBeforeRenderUI(editor);
  ...
  var $_1opdr6192jfeu9qf5 = { generate: generate };
  ...
  var fromDom = function (node) {
    ...
    return { dom: $_c7eek2172jfeu9q7g.constant(node) };
  };
  var fromPoint = function (doc, x, y) {
    return Option.from(doc.dom().elementFromPoint(x, y)).map(fromDom);
  };
  var $_edo869193jfeu9qf8 = {
    fromHtml: fromHtml,
    fromTag: fromTag,
    fromText: fromText,
    fromDom: fromDom,
  ...
  var $_frb1an197jfeu9qfr = { cached: cached };

  var $_1tknne199jfeu9qfv = {
    ATTRIBUTE: 2,
    CDATA_SECTION: 4,
    COMMENT: 8,
    DOCUMENT: 9,
  ...
  var isComment = function (element) {
    return type(element) === $_1tknne199jfeu9qfv.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_1tknne199jfeu9qfv.ELEMENT);
  var isText = isType$1($_1tknne199jfeu9qfv.TEXT);
  var isDocument = isType$1($_1tknne199jfeu9qfv.DOCUMENT);
  var $_81omdo198jfeu9qft = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_81omdo198jfeu9qft.isText(element) ? element.dom().parentNode : element.dom();
    return dom !== undefined && dom !== null && dom.ownerDocument.body.contains(dom);
  };
  var body = $_frb1an197jfeu9qfr.cached(function () {
    return getBody($_edo869193jfeu9qf8.fromDom(document));
  });
  var getBody = function (doc) {
    var body = doc.dom().body;
    if (body === null || body === undefined)
      throw 'Body is not available yet';
    return $_edo869193jfeu9qf8.fromDom(body);
  };
  var $_4yj4vu196jfeu9qfm = {
    body: body,
    getBody: getBody,
    inBody: inBody
  };
  ...
  function Immutable () {
    ...
    return function () {
      ...
      var struct = {};
      $_49sleu170jfeu9q78.each(fields, function (name, i) {
        struct[name] = $_c7eek2172jfeu9q7g.constant(values[i]);
      });
      return struct;
    };
  }
  ...
  var validateStrArr = function (label, array) {
    if (!$_6gn4r319bjfeu9qga.isArray(array))
      throw new Error('The ' + label + ' fields must be an array. Was: ' + array + '.');
    $_49sleu170jfeu9q78.each(array, function (a) {
      if (!$_6gn4r319bjfeu9qga.isString(a))
  ...
  var checkDupes = function (everything) {
    ...
    var dupe = $_49sleu170jfeu9q78.find(sorted, function (s, i) {
  ...
  function MixedBag (required, optional) {
    ...
    $_aaimya19gjfeu9qgw.validateStrArr('required', required);
    $_aaimya19gjfeu9qgw.validateStrArr('optional', optional);
    $_aaimya19gjfeu9qgw.checkDupes(everything);
    return function (obj) {
      var keys = $_dh1axa19fjfeu9qgs.keys(obj);
      var allReqd = $_49sleu170jfeu9q78.forall(required, function (req) {
        return $_49sleu170jfeu9q78.contains(keys, req);
      });
      if (!allReqd)
        $_aaimya19gjfeu9qgw.reqMessage(required, keys);
      var unsupported = $_49sleu170jfeu9q78.filter(keys, function (key) {
        return !$_49sleu170jfeu9q78.contains(everything, key);
      });
      if (unsupported.length > 0)
        $_aaimya19gjfeu9qgw.unsuppMessage(unsupported);
      var r = {};
      $_49sleu170jfeu9q78.each(required, function (req) {
        r[req] = $_c7eek2172jfeu9q7g.constant(obj[req]);
      });
      $_49sleu170jfeu9q78.each(optional, function (opt) {
        r[opt] = $_c7eek2172jfeu9q7g.constant(Object.prototype.hasOwnProperty.call(obj, opt) ? Option.some(obj[opt]) : Option.none());
      });
      return r;
    };
  }

  var $_21gjvg19cjfeu9qgc = {
    immutable: Immutable,
  ...
  var $_7e455h19hjfeu9qgz = { toArray: toArray };

  var node = function () {
    var f = $_d8ys3r180jfeu9qb7.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_edoie319njfeu9qhz.unknown()
    });
  };
  ...
  var $_a991o619mjfeu9qht = {
    unknown: unknown$1,
    nu: nu$1,
    edge: $_c7eek2172jfeu9q7g.constant(edge),
    chrome: $_c7eek2172jfeu9q7g.constant(chrome),
    ie: $_c7eek2172jfeu9q7g.constant(ie),
    opera: $_c7eek2172jfeu9q7g.constant(opera),
    firefox: $_c7eek2172jfeu9q7g.constant(firefox),
    safari: $_c7eek2172jfeu9q7g.constant(safari)
  };
  ...
  var $_bfqtnw19ojfeu9qi2 = {
    unknown: unknown$2,
    nu: nu$2,
    windows: $_c7eek2172jfeu9q7g.constant(windows$1),
    ios: $_c7eek2172jfeu9q7g.constant(ios),
    android: $_c7eek2172jfeu9q7g.constant(android),
    linux: $_c7eek2172jfeu9q7g.constant(linux),
    osx: $_c7eek2172jfeu9q7g.constant(osx),
    solaris: $_c7eek2172jfeu9q7g.constant(solaris),
    freebsd: $_c7eek2172jfeu9q7g.constant(freebsd)
  };
  ...
  function DeviceType (os, browser, userAgent) {
    ...
    return {
      isiPad: $_c7eek2172jfeu9q7g.constant(isiPad),
      isiPhone: $_c7eek2172jfeu9q7g.constant(isiPhone),
      isTablet: $_c7eek2172jfeu9q7g.constant(isTablet),
      isPhone: $_c7eek2172jfeu9q7g.constant(isPhone),
      isTouch: $_c7eek2172jfeu9q7g.constant(isTouch),
      isAndroid: os.isAndroid,
      isiOS: os.isiOS,
      isWebView: $_c7eek2172jfeu9q7g.constant(iOSwebview)
    };
  }

  var detect$1 = function (candidates, userAgent) {
    var agent = String(userAgent).toLowerCase();
    return $_49sleu170jfeu9q78.find(candidates, function (candidate) {
      return candidate.search(agent);
    });
  };
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_edoie319njfeu9qhz.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_edoie319njfeu9qhz.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_ggi7iw19tjfeu9qj6.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_ggi7iw19tjfeu9qj6.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_ggi7iw19tjfeu9qj6.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_ggi7iw19tjfeu9qj6.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_51nzfv19ujfeu9qj9.head(str).bind(function (head) {
      return $_51nzfv19ujfeu9qj9.tail(str).map(function (tail) {
  ...
  var checkContains = function (target) {
    return function (uastring) {
      return $_din49k19sjfeu9qiz.contains(uastring, target);
    };
  };
  var browsers = [
    {
      ...
      search: function (uastring) {
        var monstrosity = $_din49k19sjfeu9qiz.contains(uastring, 'edge/') && $_din49k19sjfeu9qiz.contains(uastring, 'chrome') && $_din49k19sjfeu9qiz.contains(uastring, 'safari') && $_din49k19sjfeu9qiz.contains(uastring, 'applewebkit');
        return monstrosity;
      }
    },
    {
      ...
      search: function (uastring) {
        return $_din49k19sjfeu9qiz.contains(uastring, 'chrome') && !$_din49k19sjfeu9qiz.contains(uastring, 'chromeframe');
      }
    },
    {
      name: 'IE',
      ...
      search: function (uastring) {
        return $_din49k19sjfeu9qiz.contains(uastring, 'msie') || $_din49k19sjfeu9qiz.contains(uastring, 'trident');
      }
    },
    {
      name: 'Opera',
    ...
    },
    {
      ...
      search: function (uastring) {
        return ($_din49k19sjfeu9qiz.contains(uastring, 'safari') || $_din49k19sjfeu9qiz.contains(uastring, 'mobile/')) && $_din49k19sjfeu9qiz.contains(uastring, 'applewebkit');
      }
    }
  ];
  var oses = [
    ...
    },
    {
      name: 'iOS',
      search: function (uastring) {
        return $_din49k19sjfeu9qiz.contains(uastring, 'iphone') || $_din49k19sjfeu9qiz.contains(uastring, 'ipad');
      },
      versionRegexes: [
        /.*?version\/\ ?([0-9]+)\.([0-9]+).*/,
        /.*cpu os ([0-9]+)_([0-9]+).*/,
  ...
  var $_f5n35k19rjfeu9qip = {
    browsers: $_c7eek2172jfeu9q7g.constant(browsers),
    oses: $_c7eek2172jfeu9q7g.constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_f5n35k19rjfeu9qip.browsers();
    var oses = $_f5n35k19rjfeu9qip.oses();
    var browser = $_adgdhz19qjfeu9qif.detectBrowser(browsers, userAgent).fold($_a991o619mjfeu9qht.unknown, $_a991o619mjfeu9qht.nu);
    var os = $_adgdhz19qjfeu9qif.detectOs(oses, userAgent).fold($_bfqtnw19ojfeu9qi2.unknown, $_bfqtnw19ojfeu9qi2.nu);
  ...
  var $_5bj11v19ljfeu9qhm = { detect: detect$2 };

  var detect$3 = $_frb1an197jfeu9qfr.cached(function () {
    var userAgent = navigator.userAgent;
    return $_5bj11v19ljfeu9qhm.detect(userAgent);
  });
  var $_9rov4p19kjfeu9qhh = { detect: detect$3 };

  var ELEMENT = $_1tknne199jfeu9qfv.ELEMENT;
  var DOCUMENT = $_1tknne199jfeu9qfv.DOCUMENT;
  ...
  var all = function (selector, scope) {
    ...
    return bypassSelector(base) ? [] : $_49sleu170jfeu9q78.map(base.querySelectorAll(selector), $_edo869193jfeu9qf8.fromDom);
  };
  var one = function (selector, scope) {
    var base = scope === undefined ? document : scope.dom();
    return bypassSelector(base) ? Option.none() : Option.from(base.querySelector(selector)).map($_edo869193jfeu9qf8.fromDom);
  };
  var $_45yai219vjfeu9qjd = {
    all: all,
    is: is,
    one: one
  };
  ...
  var member = function (element, elements) {
    return $_49sleu170jfeu9q78.exists(elements, $_c7eek2172jfeu9q7g.curry(eq, element));
  };
  ...
  var ieContains = function (e1, e2) {
    return $_1x1cpx19jjfeu9qhf.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_9rov4p19kjfeu9qhh.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_45door19ijfeu9qh1 = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_45yai219vjfeu9qjd.is
  };

  var owner = function (element) {
    return $_edo869193jfeu9qf8.fromDom(element.dom().ownerDocument);
  };
  var documentElement = function (element) {
    var doc = owner(element);
    return $_edo869193jfeu9qf8.fromDom(doc.dom().documentElement);
  };
  var defaultView = function (element) {
    var el = element.dom();
    var defaultView = el.ownerDocument.defaultView;
    return $_edo869193jfeu9qf8.fromDom(defaultView);
  };
  var parent$1 = function (element) {
    var dom = element.dom();
    return Option.from(dom.parentNode).map($_edo869193jfeu9qf8.fromDom);
  };
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      var kin = children(p);
      return $_49sleu170jfeu9q78.findIndex(kin, function (elem) {
        return $_45door19ijfeu9qh1.eq(element, elem);
      });
    });
  };
  var parents = function (element, isRoot) {
    var stop = $_6gn4r319bjfeu9qga.isFunction(isRoot) ? isRoot : $_c7eek2172jfeu9q7g.constant(false);
    var dom = element.dom();
    var ret = [];
    while (dom.parentNode !== null && dom.parentNode !== undefined) {
      var rawParent = dom.parentNode;
      var parent = $_edo869193jfeu9qf8.fromDom(rawParent);
      ret.push(parent);
      if (stop(parent) === true)
        break;
      else
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return $_49sleu170jfeu9q78.filter(elements, function (x) {
        return !$_45door19ijfeu9qh1.eq(element, x);
      });
    };
  ...
  var offsetParent = function (element) {
    var dom = element.dom();
    return Option.from(dom.offsetParent).map($_edo869193jfeu9qf8.fromDom);
  };
  var prevSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.previousSibling).map($_edo869193jfeu9qf8.fromDom);
  };
  var nextSibling = function (element) {
    var dom = element.dom();
    return Option.from(dom.nextSibling).map($_edo869193jfeu9qf8.fromDom);
  };
  var prevSiblings = function (element) {
    return $_49sleu170jfeu9q78.reverse($_7e455h19hjfeu9qgz.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_7e455h19hjfeu9qgz.toArray(element, nextSibling);
  };
  var children = function (element) {
    var dom = element.dom();
    return $_49sleu170jfeu9q78.map(dom.childNodes, $_edo869193jfeu9qf8.fromDom);
  };
  var child = function (element, index) {
    var children = element.dom().childNodes;
    return Option.from(children[index]).map($_edo869193jfeu9qf8.fromDom);
  };
  ...
  var spot = $_21gjvg19cjfeu9qgc.immutable('element', 'offset');
  var leaf = function (element, offset) {
    var cs = children(element);
    return cs.length > 0 && offset < cs.length ? spot(cs[offset], 0) : spot(element, offset);
  };
  var $_elo6qc19ajfeu9qfx = {
    owner: owner,
  ...
  var all$1 = function (predicate) {
    return descendants($_4yj4vu196jfeu9qfm.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return $_49sleu170jfeu9q78.filter($_elo6qc19ajfeu9qfx.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return $_49sleu170jfeu9q78.filter($_elo6qc19ajfeu9qfx.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return $_49sleu170jfeu9q78.filter($_elo6qc19ajfeu9qfx.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    $_49sleu170jfeu9q78.each($_elo6qc19ajfeu9qfx.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_45yai219vjfeu9qjd.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_c198im195jfeu9qfi.ancestors(scope, function (e) {
      return $_45yai219vjfeu9qjd.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_c198im195jfeu9qfi.siblings(scope, function (e) {
      return $_45yai219vjfeu9qjd.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_c198im195jfeu9qfi.children(scope, function (e) {
      return $_45yai219vjfeu9qjd.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_45yai219vjfeu9qjd.all(selector, scope);
  };
  var $_aqt3gl194jfeu9qfg = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return $_49sleu170jfeu9q78.map($_aqt3gl194jfeu9qfg.descendants($_edo869193jfeu9qf8.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var getOrGenerateId = function (elm) {
    return elm.id ? elm.id : $_1opdr6192jfeu9qf5.generate('h');
  };
  ...
  var anchorTarget = function (elm) {
    ...
    return create$4('anchor', anchorText ? anchorText : '#' + anchorId, '#' + anchorId, 0, $_c7eek2172jfeu9q7g.noop);
  };
  var getHeaderTargets = function (elms) {
    return $_49sleu170jfeu9q78.map($_49sleu170jfeu9q78.filter(elms, isValidHeader), headerTarget);
  };
  var getAnchorTargets = function (elms) {
    return $_49sleu170jfeu9q78.map($_49sleu170jfeu9q78.filter(elms, isValidAnchor), anchorTarget);
  };
  ...
  var find$3 = function (elm) {
    ...
    return $_49sleu170jfeu9q78.filter(getHeaderTargets(elms).concat(getAnchorTargets(elms)), hasTitle);
  };
  var $_e4qt7d191jfeu9qer = { find: find$3 };
  ...
  var staticMenuItem = function (title, url) {
    return {
      ...
      value: {
        title: title,
        url: url,
        attach: $_c7eek2172jfeu9q7g.noop
      }
    };
  };
  var isUniqueUrl = function (url, targets) {
    var foundTarget = $_49sleu170jfeu9q78.exists(targets, function (target) {
  ...
  var createMenuItems = function (term, targets, fileType, editorSettings) {
    ...
    var fromHistoryMenuItems = function (history) {
      ...
      var uniqueHistory = $_49sleu170jfeu9q78.filter(historyItems, function (url) {
    ...
    var fromMenuItems = function (type) {
      var filteredTargets = $_49sleu170jfeu9q78.filter(targets, function (target) {
    ...
    var join = function (items) {
      return $_49sleu170jfeu9q78.foldl(items, function (a, b) {
  ...
  var addToHistory = function (url, fileType) {
    ...
    if (items) {
      if ($_49sleu170jfeu9q78.indexOf(items, url) === -1) {
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_e4qt7d191jfeu9qer.find(bodyElm);
  ...
  function ClosestOrAncestor (is, ancestor, scope, a, isRoot) {
    return is(scope, a) ? Option.some(scope) : $_6gn4r319bjfeu9qga.isFunction(isRoot) && isRoot(scope) ? Option.none() : ancestor(scope, a, isRoot);
  }

  var first$1 = function (predicate) {
    return descendant($_4yj4vu196jfeu9qfm.body(), predicate);
  };
  var ancestor = function (scope, predicate, isRoot) {
    ...
    while (element.parentNode) {
      ...
      var el = $_edo869193jfeu9qf8.fromDom(element);
      if (predicate(el))
  ...
  var sibling = function (scope, predicate) {
    ...
    if (!element.parentNode)
      return Option.none();
    return child$1($_edo869193jfeu9qf8.fromDom(element.parentNode), function (x) {
      return !$_45door19ijfeu9qh1.eq(scope, x) && predicate(x);
    });
  };
  var child$1 = function (scope, predicate) {
    var result = $_49sleu170jfeu9q78.find(scope.dom().childNodes, $_c7eek2172jfeu9q7g.compose(predicate, $_edo869193jfeu9qf8.fromDom));
    return result.map($_edo869193jfeu9qf8.fromDom);
  };
  var descendant = function (scope, predicate) {
    var descend = function (element) {
      for (var i = 0; i < element.childNodes.length; i++) {
        if (predicate($_edo869193jfeu9qf8.fromDom(element.childNodes[i])))
          return Option.some($_edo869193jfeu9qf8.fromDom(element.childNodes[i]));
  ...
  var first$2 = function (selector) {
    return $_45yai219vjfeu9qjd.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_bkkpio1a1jfeu9qnu.ancestor(scope, function (e) {
      return $_45yai219vjfeu9qjd.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_bkkpio1a1jfeu9qnu.sibling(scope, function (e) {
      return $_45yai219vjfeu9qjd.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_bkkpio1a1jfeu9qnu.child(scope, function (e) {
      return $_45yai219vjfeu9qjd.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_45yai219vjfeu9qjd.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_45yai219vjfeu9qjd.is, ancestor$1, scope, selector, isRoot);
  };
  var $_q64iv1a0jfeu9qml = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
      ...
      menu: [
        {
          text: 'Left',
          icon: 'alignleft',
          onclick: $_abu17t1a4jfeu9qoh.toggleFormat(editor, 'alignleft')
        },
        {
          text: 'Center',
          icon: 'aligncenter',
          onclick: $_abu17t1a4jfeu9qoh.toggleFormat(editor, 'aligncenter')
        },
        {
          text: 'Right',
          icon: 'alignright',
          onclick: $_abu17t1a4jfeu9qoh.toggleFormat(editor, 'alignright')
        },
        {
          text: 'Justify',
          icon: 'alignjustify',
          onclick: $_abu17t1a4jfeu9qoh.toggleFormat(editor, 'alignjustify')
        }
      ]
    });
    global$4.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: item[0],
        cmd: item[1],
        onPostRender: $_abu17t1a4jfeu9qoh.postRenderFormat(editor, name)
      });
    });
  };
  var $_2kkaig1a3jfeu9qof = { register: register };
  ...
  var $_cxnw181a5jfeu9qok = { register: register$1 };
  ...
  var $_50pjgu1a6jfeu9qon = { register: register$2 };
  ...
  var createFormatMenu = function (editor) {
    ...
    return {
      ...
      itemDefaults: {
        ...
        onclick: function () {
          if (this.settings.format) {
            $_abu17t1a4jfeu9qoh.toggleFormat(editor, this.settings.format)();
          }
  ...
  var $_e8ez51a7jfeu9qoq = { register: register$3 };
      ...
      return {
        ...
        onselect: function (e) {
          if (e.control) {
            ...
            $_abu17t1a4jfeu9qoh.toggleFormat(editor, fmt)();
          }
        },
  ...
  var buildMenuItems = function (editor, blocks) {
    return global$4.map(blocks, function (block) {
      return {
        text: block[0],
        onclick: $_abu17t1a4jfeu9qoh.toggleFormat(editor, block[1]),
        textStyle: function () {
          return editor.formatter.getCssText(block[1]);
        }
      };
  ...
  var $_23jmw21a8jfeu9qou = { register: register$4 };
  ...
  var createCustomMenuItems = function (editor, names) {
    ...
    if (typeof names === 'string') {
      ...
      return $_49sleu170jfeu9q78.flatten(global$4.map(names, function (names) {
  ...
  var trimMenuItems = function (menuItems) {
    var menuItems2 = $_49sleu170jfeu9q78.filter(menuItems, function (menuItem, i, menuItems) {
      return !isSeparator(menuItem) || !isSeparator(menuItems[i - 1]);
    });
    return $_49sleu170jfeu9q78.filter(menuItems2, function (menuItem, i, menuItems) {
  ...
  var $_4gsyb21a9jfeu9qoy = { register: register$5 };
  ...
  var registerFormatButtons = function (editor) {
    global$4.each({
      ...
      editor.addButton(name, {
        ...
        tooltip: text,
        onPostRender: $_abu17t1a4jfeu9qoh.postRenderFormat(editor, name),
        onclick: $_abu17t1a4jfeu9qoh.toggleFormat(editor, name)
      });
    });
  };
  ...
  var registerMenuItems$1 = function (editor) {
    ...
    editor.addMenuItem('codeformat', {
      text: 'Code',
      icon: 'code',
      onclick: $_abu17t1a4jfeu9qoh.toggleFormat(editor, 'code')
    });
  };
  ...
  var $_9mkyq31aajfeu9qp3 = { register: register$6 };
  ...
  var $_g2kk371abjfeu9qp7 = { register: register$7 };
  ...
  var $_1tswqb1acjfeu9qp9 = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      global$1.container = $_q64iv1a0jfeu9qml.descendant($_edo869193jfeu9qf8.fromDom(document.body), editor.settings.ui_container).fold($_c7eek2172jfeu9q7g.constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_23jmw21a8jfeu9qou.register(editor);
    $_2kkaig1a3jfeu9qof.register(editor);
    $_9mkyq31aajfeu9qp3.register(editor);
    $_g2kk371abjfeu9qp7.register(editor);
    $_50pjgu1a6jfeu9qon.register(editor);
    $_cxnw181a5jfeu9qok.register(editor);
    $_e8ez51a7jfeu9qoq.register(editor);
    $_1tswqb1acjfeu9qp9.register(editor);
    $_4gsyb21a9jfeu9qoy.register(editor);
  };
  var $_6vse3a19zjfeu9qli = { setup: setup };
  ...
  var Slider = Widget.extend({
    init: function (settings) {
      ...
      self._minValue = $_6gn4r319bjfeu9qga.isNumber(settings.minValue) ? settings.minValue : 0;
      self._maxValue = $_6gn4r319bjfeu9qga.isNumber(settings.maxValue) ? settings.maxValue : 100;
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_17wfps17gjfeu9q8z,
      Control: Control$1,
      Factory: global$11,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_dz9k2z17ujfeu9qap,
      Panel: Panel,
      Movable: $_gaufhv17ijfeu9q96,
      Resizable: $_bnibyc17vjfeu9qas,
      ...
      FormatControls: $_6vse3a19zjfeu9qli,
  ...
  global.add('inlite', function (editor) {
    var panel = create$3();
    $_6vse3a19zjfeu9qli.setup(editor);
    $_fll43817xjfeu9qax.addToEditor(editor, panel);
    return $_mx5zb16ejfeu9q5n.get(editor, panel);
  });
  function Theme () {
  }
